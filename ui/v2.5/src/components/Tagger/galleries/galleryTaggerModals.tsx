...
export interface IGalleryTaggerModalsContextState {
...
export const GalleryTaggerModalsState =
  React.createContext<IGalleryTaggerModalsContextState>({
    createPerformerModal: () => {},
    createStudioModal: () => {},
    createTagModal: () => {},
  });

export const GalleryTaggerModals: React.FC = ({ children }) => {
  ...
  return (
    <GalleryTaggerModalsState.Provider
